...
e = Events(degree = EventDrunk([EventSeq([5.00, 5.02, 5.03], 1), EventSeq([5.07, 5.05, 5.03], 1),
                                EventSeq([5.07, 5.08, 5.11], 1), EventSeq([6.00, 6.07, 6.03], 1),
                                EventSeq([6.07, 6.05, 6.07], 1), EventSeq([6.07, 6.08, 6.11], 1),
