#! /usr/bin/env python
"""
This script removes versions of pyo prior to 1.0.0 (before pyo is installed with pip).
...
def main():
    if sys.platform == "darwin":
        PATHS = ["/Library/Python/%d.%d/site-packages/" % (VERSION_MAJOR, VERSION_MINOR),
                "/Library/Frameworks/Python.framework/Versions/%d.%d/lib/python%d.%d/site-packages/" % (VERSION_MAJOR, VERSION_MINOR, VERSION_MAJOR, VERSION_MINOR),
