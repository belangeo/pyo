...
# with python 3.5.4 (32/64-bit) and wxpython 4.0.3 (phoenix) installed
...
export PACKAGE_NAME=pyo_0.9.1_x86_64_py35.pkg
export DMG_DIR="pyo 0.9.1 py35 Universal"
export DMG_NAME="pyo_0.9.1_OSX_py35-universal.dmg"
