...
# with python 2.7.14 (32/64-bit) and wxpython 3.0.2.0 (classic) installed
...
export PACKAGE_NAME=pyo_0.9.1_x86_64_py2.pkg
export DMG_DIR="pyo 0.9.1 py2 Universal"
export DMG_NAME="pyo_0.9.1_OSX_py2-universal.dmg"
