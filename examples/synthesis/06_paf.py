...
class PAF:
    ...
    def __init__(self, f0, fc, bw, fs, amp):
        ...
        self.f0, self.fc, self.bw, self.fs, self.amp = Sig(f0), Sig(fc), Sig(bw), Sig(fs), Sig(amp)
...
for_tenor = {"ou": [290, 750, 2300, 3080], "o": [360, 770, 2530, 3200], "oo": [520, 900, 2510, 3310,],
        "aa": [710, 1230, 2700, 3700], "a": [750, 1450, 2590, 3280], "ee": [590, 1770, 2580, 3480],
...
bw_tenor = {"ou": [30, 35, 45, 50], "o": [30, 35, 54, 59], "oo": [35, 40, 54, 59], "aa": [40, 45, 59, 64],
            "a": [40, 45, 59, 64], "ee": [40, 45, 59, 64], "oee": [40, 45, 59, 64], "oe": [45, 54, 64, 69],
            "eu": [40, 54, 59, 64], "e": [35, 54, 59, 64], "u": [35, 50, 50, 59], "i": [25, 50, 54, 59]}

vib = Sine(Randi(4,5,.1), mul=.005, add=1)
