...
{"out", (PyCFunction)RandInt_out, METH_VARARGS, "Starts computing and sends sound to soundcard channel speficied by argument."},
...
static PyMethodDef Xnoise_methods[] = {
    ...
    {"out", (PyCFunction)Xnoise_out, METH_VARARGS, "Starts computing and sends sound to soundcard channel speficied by argument."},
...
static PyMethodDef XnoiseMidi_methods[] = {
    ...
    {"out", (PyCFunction)XnoiseMidi_out, METH_VARARGS, "Starts computing and sends sound to soundcard channel speficied by argument."},
