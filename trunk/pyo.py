...
OBJECTS_TREE = {'functions': sorted(['pa_count_devices', 'pa_get_default_input', 'pa_get_default_output', 
        ...
        'PyoObject': {'analysis': sorted(['Follower', 'ZCross']),
                      ...
                      'effects': sorted(['Delay', 'Disto', 'Freeverb', 'Waveguide', 'Convolve', 'WGVerb', 'Harmonizer', 'Chorus']),
                      'filters': sorted(['Biquad', 'BandSplit', 'Port', 'Hilbert', 'Tone', 'DCBlock', 'EQ', 'Allpass',
                                         'Allpass2', 'Phaser', 'Biquadx']),
                      ...
                      'tableprocess': sorted(['TableRec', 'Osc', 'Pointer', 'Lookup', 'Granulator', 'Pulsar', 
                                            'TableRead', 'TableMorph', 'Looper', 'Index']),
                      ...
                      'triggers': sorted(['Metro', 'Beat', 'TrigEnv', 'TrigRand', 'Select', 'Counter', 'TrigChoice', 
                                        ...
                                        'Change', 'TrigLinseg', 'TrigExpseg', 'Percent']),
                      'utils': sorted(['Clean_objects', 'Print', 'Snap', 'Interp', 'SampHold', 'Compare', 'Record']),
